					...
					<div class="row gap-20 masonry pos-r">
						...
						<div class="masonry-item col-md-6 offset-md-3">
							<div class="bgc-white p-20 bd">
								<h6 class="c-grey-900">Receive Payment</h6>
								<div class="mT-30">
									<form action="payfees-p.php" method="post">
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="adm">Admission No.</label><input class="form-control" name="adm" placeholder="1234" type="number">
											</div>
											<div class="form-group col-md-6">
												<label for="name">Amount</label><input class="form-control" name="amount" placeholder="20,000" type="number">
											</div>
										</div>
										<div class="form-group col-md-4">
											<label for="form">Payment Mode</label><select class="form-control" name="mode">
										...
										</div><button class="btn btn-primary" name="payfees" type="submit">Submit</button>
									</form>
								</div>
							</div>
						</div>
